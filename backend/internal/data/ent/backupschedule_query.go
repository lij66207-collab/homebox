...
func (_q *BackupScheduleQuery) QueryGroup() *GroupQuery {
...
func (_q *BackupScheduleQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *BackupScheduleQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (_q *BackupScheduleQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *BackupScheduleQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (_q *BackupScheduleQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (_q *BackupScheduleQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *BackupScheduleQuery) WithGroup(opts ...func(*GroupQuery)) *BackupScheduleQuery {
	query := (&GroupClient{config: _q.config}).Query()
...
func (_q *BackupScheduleQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*BackupSchedule, error) {
	...
	if query := _q.withGroup; query != nil {
		if err := _q.loadGroup(ctx, query, nodes, nil,
			func(n *BackupSchedule, e *Group) { n.Edges.Group = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *BackupScheduleQuery) loadGroup(ctx context.Context, query *GroupQuery, nodes []*BackupSchedule, init func(*BackupSchedule), assign func(*BackupSchedule, *Group)) error {
	ids := make([]uuid.UUID, 0, len(nodes))
	nodeids := make(map[uuid.UUID][]*BackupSchedule)
	for i := range nodes {
		fk := nodes[i].GroupID
...
func (_q *BackupScheduleQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(backupschedule.Table, backupschedule.Columns, sqlgraph.NewFieldSpec(backupschedule.FieldID, field.TypeUUID))
	_spec.From = _q.sql
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withGroup != nil {
			_spec.Node.AddColumnOnce(backupschedule.FieldGroupID)
		}
	}
