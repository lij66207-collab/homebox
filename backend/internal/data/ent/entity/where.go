...
// LowStockNotified applies equality check predicate on the "low_stock_notified" field. It's identical to LowStockNotifiedEQ.
func LowStockNotified(v bool) predicate.Entity {
	return predicate.Entity(sql.FieldEQ(FieldLowStockNotified, v))
}
...
// LowStockNotifiedEQ applies the EQ predicate on the "low_stock_notified" field.
func LowStockNotifiedEQ(v bool) predicate.Entity {
	return predicate.Entity(sql.FieldEQ(FieldLowStockNotified, v))
}

// LowStockNotifiedNEQ applies the NEQ predicate on the "low_stock_notified" field.
func LowStockNotifiedNEQ(v bool) predicate.Entity {
	return predicate.Entity(sql.FieldNEQ(FieldLowStockNotified, v))
}
