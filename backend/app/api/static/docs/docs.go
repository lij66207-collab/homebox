...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/v1/assistant/voice": {
            "post": {
                ...
                "parameters": [
                    {
                        "type": "file",
                        "description": "Recorded audio clip (max 10MB)",
                        "name": "audio",
                        "in": "formData",
                        "required": true
                    },
                    {
                        "type": "string",
                        "description": "JSON array of prior conversation messages [{\\",
                        "name": "history",
                        "in": "formData"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/v1.assistantVoiceResponse"
                        }
                    },
                    "400": {
        ...
        "/v1/group/settings/test-serverchan": {
            "post": {
                "security": [
                    {
                        "Bearer": []
                ...
                "parameters": [
                    {
                        "description": "Test payload; empty sendkey uses the stored one",
                        "name": "payload",
                        "in": "body",
                        "schema": {
                            "$ref": "#/definitions/v1.GroupTestServerChanRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "v1.assistantVoiceResponse": {
            "type": "object",
            "properties": {
                "actions": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/services.AssistantAction"
                    }
                },
                "reply": {
                    "type": "string"
